            ...
            <form class="forms-sample" action="{{ route('users.update', $user->user_id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-4">
                    ...
                    <select class="form-select" name="study_program">
                        ...
                        <option value="Teknik Sipil" {{ $user->study_program == 'Teknik Sipil' ? 'selected' : '' }}>Teknik Sipil</option>
                        <option value="Informatika" {{ $user->study_program == 'Informatika' ? 'selected' : '' }}>Informatika</option>
                        <option value="Teknik Mesin" {{ $user->study_program == 'Teknik Mesin' ? 'selected' : '' }}>Teknik Mesin</option>
                    </select>
                    @error('program_study')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
