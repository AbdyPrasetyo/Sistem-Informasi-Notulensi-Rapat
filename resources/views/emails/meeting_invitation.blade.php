...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p><i class="fas fa-globe icon"></i>Login situs web kami untuk  memantau informasi jadwal rapat anda di <a href="{{ url('/') }}">http://janameet.ac.id/</a>.</p><br>
            <p>Terima kasih,</p>
