    ...
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="details">
                <ol>
                    <p>
                        ...
                        <li><i class="fas fa-globe icon"></i>Kunjungi situs web kami di <a href="{{ url('/') }}">http://janameet.ac.id/</a>.</li><br>
                    </p>
                    <p>
            ...
            <p>Jika Anda mengalami kesulitan atau memiliki pertanyaan lebih lanjut, jangan ragu untuk menghubungi tim
                dukungan kami di <a href="meylian2305@gmail.com

                ">meylian2305@gmail.com

                            </a> atau +62 897-9497-051.</p><br>
