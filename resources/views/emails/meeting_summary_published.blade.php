...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p><i class="fas fa-globe icon"></i>Login situs web kami untuk  memantau informasi hasil rapat lebih detail di <a href="{{ url('/') }}">http://janameet.ac.id/</a>.</p><br>
            <p>Jika Anda memiliki pertanyaan lebih lanjut atau membutuhkan klarifikasi, jangan ragu untuk menghubungi kami di <a href="meylian2305@gmail.com

">meylian2305@gmail.com

            </a> atau +62 897-9497-051.</p>
