...
.fc-button-primary {
    background-color: #5d87ff !important; /* Warna latar belakang aktif (hari ini) */
    border-color: #5d87ff !important; /* Warna border aktif (hari ini) */
}

.fc-button-primary:hover {
    background-color: #2e5fe4 !important; /* Warna latar belakang saat hover (hari ini) */
    border-color: #2e5fe4 !important; /* Warna border saat hover (hari ini) */
}
